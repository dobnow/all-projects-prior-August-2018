...
public class ElFieldSignInspectionTest extends TestBase {
	@BeforeSuite
...
//		quitDriver();
	...
	public Object[][] getTestData() {
		return TestUtil.getData("ElFieldSignInspectionTest", xlsx);
	}
	...
	public void GI(Hashtable<String, String> data) {
		if (!TestUtil.isExecutable("ElFieldSignInspectionTest", xlsx) || data.get("Runmode").equals("N"))
