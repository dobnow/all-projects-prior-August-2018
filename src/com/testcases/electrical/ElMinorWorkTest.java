...
public class ElMinorWorkTest extends TestBase {
	@BeforeSuite
	...
	public Object[][] getTestData() {
		return TestUtil.getData("ElMinorWorkTest", xlsx);
	}
	...
	public void GI(Hashtable<String, String> data) {
		if (!TestUtil.isExecutable("ElMinorWorkTest", xlsx) || data.get("Runmode").equals("N"))
