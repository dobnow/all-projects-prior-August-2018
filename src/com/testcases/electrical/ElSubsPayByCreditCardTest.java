...
public class ElSubsPayByCreditCardTest extends TestBase {
	@BeforeSuite
	...
	public Object[][] getTestData() {
		return TestUtil.getData("ElSubsPayByCreditCardTest", xlsx);
	}
	...
	public void GI(Hashtable<String, String> data) {
		if (!TestUtil.isExecutable("ElSubsPayByCreditCardTest", xlsx) || data.get("Runmode").equals("N"))
