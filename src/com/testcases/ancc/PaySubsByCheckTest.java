...
public class PaySubsByCheckTest extends TestBase {
	...
	public Object[][] getTestData() {
		return TestUtil.getData("PaySubsByCheckTest", xlsx);
	}

	@Test(priority = 0, dataProvider = "getTestData")
	public void Base(Hashtable<String, String> data) {
		if (!TestUtil.isExecutable("PaySubsByCheckTest", xlsx) || data.get("Runmode").equals("N"))
